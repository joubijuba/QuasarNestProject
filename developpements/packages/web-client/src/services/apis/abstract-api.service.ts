...
export abstract class AbstractApiService {
  ...
  private static _thenHandler<R>(
    response: AxiosResponse<WorkDone<R>>,
  ): WorkDone<R> | Promise<WorkDone<R>> {
  ...
  protected async doGet<R>(
    ...
    try {
      const resp = await this._axiosInstance.get<WorkDone<R>>(
  ...
  protected async doPost<R>(
    ...
    try {
      const resp = await this._axiosInstance.post<WorkDone<R>>(
        `${this._serviceApiBaseUrl}${serviceUri}`,
        params,
        runConfig,
      );
  ...
  protected async doPut<R>(
    ...
    try {
      const resp = await this._axiosInstance.put<WorkDone<R>>(
        `${this._serviceApiBaseUrl}${serviceUri}`,
        params,
        runConfig,
      );
  ...
  protected async doDelete<R>(
    ...
    try {
      ...
      /// This is how we handle delete requests that contain
